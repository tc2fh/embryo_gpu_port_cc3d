...
under pytest for the Phase 7 tests.
...
Phase 7 tests import the engine + embryo packages with simple absolute imports
...
_PHASE7 = os.path.dirname(os.path.abspath(__file__))
_GPU_PORT = os.path.dirname(_PHASE7)  # .../gpu_port  (contains the `engine` package)
